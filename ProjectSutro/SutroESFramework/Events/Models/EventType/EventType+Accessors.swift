...
extension EventType {
    // MARK: Process events
    public var exec: ProcessExecEvent? {
        if case .exec(let e) = self { return e }
        return nil
    }

    public var fork: ProcessForkEvent? {
        if case .fork(let e) = self { return e }
        return nil
    }

    public var exit: ProcessExitEvent? {
        if case .exit(let e) = self { return e }
        return nil
    }
    
    public var signal: ProcessSignalEvent? {
        if case .signal(let e) = self { return e }
        return nil
    }
    
    public var proc_suspend_resume: ProcessSocketEvent? {
        if case .proc_suspend_resume(let e) = self { return e }
        return nil
    }
    
    public var proc_check: ProcessCheckEvent? {
    ...
    public var remote_thread_create: RemoteThreadCreateEvent? {
        if case .remote_thread_create(let e) = self { return e }
        return nil
    }
    
    public var trace: ProcessTraceEvent? {
    ...
    public var cs_invalidated: CodeSignatureInvalidatedEvent? {
    ...
    public var mmap: MMapEvent? {
        if case .mmap(let e) = self { return e }
        return nil
    }
    
    public var mprotect: MProtectEvent? {
    ...
    public var create: FileCreateEvent? {
        if case .create(let e) = self { return e }
        return nil
    }
    
    public var rename: FileRenameEvent? {
        if case .rename(let e) = self { return e }
        return nil
    }

    public var open: FileOpenEvent? {
        if case .open(let e) = self { return e }
        return nil
    }

    public var write: FileWriteEvent? {
        if case .write(let e) = self { return e }
        return nil
    }

    public var close: FileCloseEvent? {
        if case .close(let e) = self { return e }
        return nil
    }

    public var unlink: FileDeleteEvent? {
        if case .unlink(let e) = self { return e }
        return nil
    }
    
    
    public var dup: FDDuplicateEvent? {
    ...
    public var setextattr: XattrSetEvent? {
        if case .setextattr(let e) = self { return e }
        return nil
    }
    
    public var getextattr: XattrGetEvent? {
        if case .getextattr(let e) = self { return e }
        return nil
    }
    
    public var listextattr: XattrListEvent? {
        if case .listextattr(let e) = self { return e }
        return nil
    }

    public var deleteextattr: XattrDeleteEvent? {
        if case .deleteextattr(let e) = self { return e }
        return nil
    }
    
    public var setmode: SetModeEvent? {
    ...
    public var pty_grant: PTYGrantEvent? {
    ...
    public var btm_launch_item_add: LaunchItemAddEvent? {
        if case .btm_launch_item_add(let e) = self { return e }
        return nil
    }

    public var btm_launch_item_remove: LaunchItemRemoveEvent? {
    ...
    // MARK: OpenSSH events
    public var openssh_login: SSHLoginEvent? {
        if case .openssh_login(let e) = self { return e }
        return nil
    }

    public var openssh_logout: SSHLogoutEvent? {
    ...
    public var xp_malware_detected: XProtectDetectEvent? {
        if case .xp_malware_detected(let e) = self { return e }
        return nil
    }

    public var xp_malware_remediated: XProtecRemediateEvent? {
    ...
    // MARK: Login events
    public var login_login: LoginLoginEvent? {
        if case .login_login(let e) = self { return e }
        return nil
    }

    public var lw_session_login: LWLoginEvent? {
        if case .lw_session_login(let e) = self { return e }
        return nil
    }

    public var lw_session_unlock: LWUnlockEvent? {
    ...
    // MARK: Kernel events
    public var iokit_open: IOKitOpenEvent? {
    ...
    public var get_task: GetTaskEvent? {
    ...
    // MARK: MDM events
    public var profile_add: ProfileAddEvent? {
    ...
    public var authorization_petition: AuthorizationPetitionEvent? {
        if case .authorization_petition(let e) = self { return e }
        return nil
    }

    public var authorization_judgement: AuthorizationJudgementEvent? {
    ...
    public var od_create_user: OpenDirectoryCreateUserEvent? {
        if case .od_create_user(let e) = self { return e }
        return nil
    }

    public var od_modify_password: OpenDirectoryModifyPasswordEvent? {
        if case .od_modify_password(let e) = self { return e }
        return nil
    }

    public var od_group_add: OpenDirectoryGroupAddEvent? {
        if case .od_group_add(let e) = self { return e }
        return nil
    }

    public var od_group_remove: OpenDirectoryGroupRemoveEvent? {
        if case .od_group_remove(let e) = self { return e }
        return nil
    }

    public var od_create_group: OpenDirectoryCreateGroupEvent? {
        if case .od_create_group(let e) = self { return e }
        return nil
    }

    public var od_attribute_value_add: OpenDirectoryAttributeValueAddEvent? {
    ...
    // MARK: XPC events
    public var xpc_connect: XPCConnectEvent? {
    ...
    // MARK: Socket events
    public var uipc_connect: UIPCConnectEvent? {
        if case .uipc_connect(let e) = self { return e }
        return nil
    }
    
    public var uipc_bind: UIPCBindEvent? {
    ...
    // MARK: TCC events
    public var tcc_modify: TCCModifyEvent? {
        if case .tcc_modify(let e) = self { return e }
        return nil
    }
    
    // MARK: Gatekeeper events
    public var gatekeeper_user_override: GatekeeperUserOverrideEvent? {
