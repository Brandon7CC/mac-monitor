//
//  UnifiedSystemEventsTableController.swift
//  ProjectSutro
//
//  NSTableView controller for unified system events (Ventura / macOS 13).
//  6 columns: Timestamp, Event type, Context, Effective user, Source process, Source Signing ID
//
...
class UnifiedSystemEventsTableController: SystemEventsTableController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        setupColumns(for: .unified(customizable: false))
...
extension UnifiedSystemEventsTableController {
    func tableView(_ tableView: NSTableView, viewFor tableColumn: NSTableColumn?, row: Int) -> NSView? {
        ...
        case .effectiveUser:
            let cell = makeTextCellView()
            cell.setText(message.process.euid_human ?? "Unknown")
            return cell
...
extension UnifiedSystemEventsTableController: NSMenuDelegate {
